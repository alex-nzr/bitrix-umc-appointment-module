...
(function (exports,date,main_core,ui_dialogs_messagebox) {
    ...
    babelHelpers.createClass(Renderer, [{
      ...
      value: function renderSelectionItems(listNode, dataKey, items) {
        for (var key in items) {
          ...
          } else if (dataKey === this.application.dataKeys.clinicsKey) {
            this.renderClinicItem(listNode, items[key]);
          } else {
      ...
      key: "renderClinicItem",
      value: function renderClinicItem(listNode, clinicItem) {
        var _clinicItem$departmen;
        var departments = (_clinicItem$departmen = clinicItem.departments) !== null && _clinicItem$departmen !== void 0 ? _clinicItem$departmen : {};
        if (Object.keys(departments).length > 0) {
          for (var key in departments) {
            ...
            var dataAttrs = {
              clinic: clinicItem.uid,
              uid: departments[key].uid,
              name: departments[key].name
            };
            BX.append(BX.create('li', {
              dataset: dataAttrs,
              html: departments[key].name
            }), listNode);
          }
        }
      }
  ...
  var AppointmentSteps = /*#__PURE__*/function () {
    ...
    function AppointmentSteps(params) {
      ...
      babelHelpers.defineProperty(this, "departmentKey", "department");
      ...
      this.filledInputs = (_this$filledInputs9 = {}, babelHelpers.defineProperty(_this$filledInputs9, this.dataKeys.clinicsKey, {
        clinicUid: false,
        clinicName: false
      }), babelHelpers.defineProperty(_this$filledInputs9, this.departmentKey, {
        departmentUid: false,
    ...
    babelHelpers.createClass(AppointmentSteps, [{
      ...
      value: function getSchedule(clinicUid, employeeUid) {
        ...
        if ((_this$data$this$dataK = this.data[this.dataKeys.scheduleKey]) !== null && _this$data$this$dataK !== void 0 && (_this$data$this$dataK2 = _this$data$this$dataK[clinicUid]) !== null && _this$data$this$dataK2 !== void 0 && (_this$data$this$dataK3 = _this$data$this$dataK2[selectedDeptUid]) !== null && _this$data$this$dataK3 !== void 0 && (_this$data$this$dataK4 = _this$data$this$dataK3[selectedSpecialtyUid]) !== null && _this$data$this$dataK4 !== void 0 && _this$data$this$dataK4[employeeUid]) {
          ...
          BX.ajax.runAction('anz:appointment.oneCController.getSchedule', {
            ...
            var _scheduleResponse$dat, _scheduleResponse$dat3, _scheduleResponse$dat4, _scheduleResponse$dat5;
            ...
            if (!_this7.data.schedule[clinicUid][selectedDeptUid]) {
              _this7.data.schedule[clinicUid][selectedDeptUid] = {};
            }
            if (!_this7.data.schedule[clinicUid][selectedDeptUid][selectedSpecialtyUid]) {
              _this7.data.schedule[clinicUid][selectedDeptUid][selectedSpecialtyUid] = {};
            }
            if (babelHelpers["typeof"]((_scheduleResponse$dat3 = scheduleResponse.data) === null || _scheduleResponse$dat3 === void 0 ? void 0 : (_scheduleResponse$dat4 = _scheduleResponse$dat3[clinicUid]) === null || _scheduleResponse$dat4 === void 0 ? void 0 : (_scheduleResponse$dat5 = _scheduleResponse$dat4[selectedDeptUid]) === null || _scheduleResponse$dat5 === void 0 ? void 0 : _scheduleResponse$dat5[selectedSpecialtyUid]) === 'object') {
              var _scheduleResponse$dat6;
              _this7.data.schedule[clinicUid][selectedDeptUid][selectedSpecialtyUid][employeeUid] = (_scheduleResponse$dat6 = scheduleResponse.data[clinicUid][selectedDeptUid][selectedSpecialtyUid][employeeUid]) !== null && _scheduleResponse$dat6 !== void 0 ? _scheduleResponse$dat6 : {};
            } else {
              _this7.data.schedule[clinicUid][selectedDeptUid][selectedSpecialtyUid][employeeUid] = {};
            }
      ...
      value: function renderBlock(dataKey) {
        ...
        if (dataKey === this.dataKeys.scheduleKey) {
          var _items$selectedClinic, _items$selectedClinic2, _items$selectedClinic3;
          ...
          if (babelHelpers["typeof"]((_items$selectedClinic = items[selectedClinic]) === null || _items$selectedClinic === void 0 ? void 0 : (_items$selectedClinic2 = _items$selectedClinic[selectedDeptUid]) === null || _items$selectedClinic2 === void 0 ? void 0 : (_items$selectedClinic3 = _items$selectedClinic2[selectedSpecialtyUid]) === null || _items$selectedClinic3 === void 0 ? void 0 : _items$selectedClinic3[selectedEmployeeUid]) === 'object') {
      ...
      value: function allowToRender(listNode, dataKey, item) {
        var canRender = true;
        var selectedClinic = this.filledInputs[this.dataKeys.clinicsKey].clinicUid;
        var selectedDepartment = this.filledInputs[this.departmentKey].departmentUid;
        var selectedSpecialtyUid = this.filledInputs[this.dataKeys.specialtiesKey].specialtyUid;
        var selectedEmployeeUid = this.filledInputs[this.dataKeys.employeesKey].employeeUid;
        var selectedServiceUid = this.filledInputs[this.dataKeys.servicesKey].serviceUid;
        var clinicCondition, specialtyCondition, departmentCondition;
        switch (dataKey) {
          case this.dataKeys.specialtiesKey:
            ...
            departmentCondition = item.departments.includes(selectedDepartment);
            if (this.strictCheckingOfRelations) {
              canRender = clinicCondition && departmentCondition;
              if (this.showDoctorsWithoutDepartment) {
                canRender = clinicCondition && departmentCondition || item.clinics.includes('');
              }
            }
          ...
          case this.dataKeys.employeesKey:
            ...
            departmentCondition = selectedDepartment === item.departmentUid;
            canRender = specialtyCondition && departmentCondition;
            if (this.strictCheckingOfRelations) {
              if (this.showDoctorsWithoutDepartment) {
                canRender = specialtyCondition && departmentCondition && !item.clinicUid || specialtyCondition && departmentCondition && clinicCondition;
              } else {
                canRender = specialtyCondition && clinicCondition && departmentCondition;
              }
            }
      ...
      value: function getServiceDuration() {
        var _this$data$this$dataK5, _selectedEmployeeFull;
        var selectedEmployee = this.filledInputs[this.dataKeys.employeesKey];
        var selectedEmployeeFullData = (_this$data$this$dataK5 = this.data[this.dataKeys.employeesKey]) === null || _this$data$this$dataK5 === void 0 ? void 0 : _this$data$this$dataK5[selectedEmployee.employeeUid];
      ...
      value: function changeSelectionStep(dataKey, target) {
        ...
        switch (dataKey) {
          case this.dataKeys.clinicsKey:
            var clinicUid = target.dataset.clinic;
            var departmentUid = target.dataset.uid;
          ...
          case this.dataKeys.specialtiesKey:
            ...
            if (this.useServices) {
              var _clinicUid = this.filledInputs[this.dataKeys.clinicsKey].clinicUid;
              if (this.servicesStorage[_clinicUid]) {
                this.data.services = _objectSpread({}, this.servicesStorage[_clinicUid]);
              } else {
                this.getListNomenclature("".concat(_clinicUid));
              }
            }
            break;
          case this.dataKeys.servicesKey:
      ...
      value: function addSpecialty(employee) {
        if (employee.specialtyUid) {
          if (this.data[this.dataKeys.specialtiesKey][employee.specialtyUid]) {
            ...
            this.addDepartmentToSpecialty(this.data[this.dataKeys.specialtiesKey][employee.specialtyUid], employee.departmentUid);
          } else {
      ...
      key: "addDepartmentToSpecialty",
      value: function addDepartmentToSpecialty(specialty, departmentUid) {
        if (Array.isArray(specialty.departments) && !specialty.departments.includes(departmentUid)) {
          specialty.departments.push(departmentUid);
        }
      }
    }, {
      ...
      value: function submit(event) {
        ...
        if (this.checkRequiredFields()) {
          ...
          this.orderData.customParams = {
            "Podr": this.filledInputs[this.departmentKey].departmentUid
          };
