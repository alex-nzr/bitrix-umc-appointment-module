    ...
    babelHelpers.createClass(Renderer, [{
        ...
        return BX.create('div', {
          ...
          children: [BX.create('form', {
            ...
            children: [BX.create('span', {
              ...
              html: '&#10006;'
            }), this.getFormFirstBlock(), this.getFormSecondBlock(), this.getFormThirdBlock(), this.getFormMessageBlock(), this.getFormPrivacyBlock(), this.getFormResultBlock(), this.getFormLoaderBlock()]
          })]
        });
      }
    }, {
      ...
      value: function getFormFirstBlock() {
        ...
        return BX.create('div', {
          ...
          children: [].concat(babelHelpers.toConsumableArray(this.getSelectionNodes([this.application.dataKeys.clinicsKey, this.application.dataKeys.specialtiesKey])), [this.getFormButtonsBlock([doctorBtn, serviceBtn])])
        });
      }
    }, {
      ...
      value: function getFormSecondBlock() {
        ...
        var btnNext = this.getFormBtn(BX.message('FIRSTBIT_JS_FORM_BTN_NEXT'), function () {
          _this2.application.changeFormStep(_this2.application.formStepNodes.three);
        });
        return BX.create('div', {
          attrs: {
      ...
      key: "getFormThirdBlock",
      value: function getFormThirdBlock() {
        return BX.create('div', {
          attrs: {
            className: "".concat(styles['appointment-form-step'], " ").concat(styles['hidden']),
    ...
    babelHelpers.createClass(AppointmentSteps, [{
      ...
      value: function activateStepButtons() {
        if (BX.type.isDomNode(this.currentFormStep)) {
          var buttons = this.currentFormStep.querySelectorAll(".".concat(styles['appointment-form-button']));
      ...
      value: function sendOrder() {
        ...
        BX.ajax.runAction('firstbit:appointment.oneCController.addOrder', {
          ...
          _this12.form.classList.remove(styles['appointment-form-confirmation-mode'], styles['loading']);
