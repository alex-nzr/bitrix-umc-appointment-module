...
Куча багов с селектами(активность кнопок при выборе вышестоящего, при возврате. 
При повторной загрузке формы недоступна кнопка сделать запись)
Отправитель равен получатели в письмах
21 рефактор инсталлера
21.5 сделать сообщение куда пришло подтверждение на форме подтверждения
